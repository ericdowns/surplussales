<div class="flex flex-col border-b border-neutral-400 py-6 group hover:cursor-pointer">
    <div class="flex justify-between items-center content-center _pb-5">
        <h4 class="flex justify-center items-center content-center leading-none">Do we have real time inventory?</h4>
        <i class="group-hover:bg-stone-600 group-hover:text-white group-hover:border-stone-600 flex justify-center items-center w-11 h-11 rounded-full border border-neutral-400 fa-sharp fa-regular fa-angle-down"></i>
    </div>
    <div class="hidden">
