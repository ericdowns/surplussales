<div class="flex flex-col border-b border-neutral-400 pb-8">
    <div class="flex justify-between items-center content-center pb-5">
        ...
        <i class="flex justify-center items-center w-11 h-11 rounded-full border border-neutral-400 fa-sharp fa-regular fa-angle-down"></i>
    </div>
