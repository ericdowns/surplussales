        ...
        <div class="flex w-[77%] lg:w-full flex-col"> 
            <div class="flex-col flex w-full">
                ...
                <div class="text-sm leading-tight _space-y-1">
                    ...
                    <p class="text-black"> <span class="text-stone-500"> Wattage: </span> 1/8</p>
                    <p class="text-black"> <span class="text-stone-500"> Ohms:</span> 12</p>
                    <p class="text-black"> <span class="text-stone-500"> Brand:</span> Allen Bradley</p>
                    <p class="text-black pt-6 text-lg"> <span class="font-bold"> $2.00 </span> <span class="text-stone-500 font-medium"> / each </span></p>
                </div>
            </div>
            <div class="flex gap-6 items-center pt-3">
                <div class="flex gap-3 items-center">
                    <input type="number" class="w-auto h-10 max-w-[60px] inputstyle" value="1"></input>
