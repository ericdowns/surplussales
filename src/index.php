...
<body>
    ...
    <style> *{  outline: 1px solid rgba(187, 187, 187, 0.4); } </style>
    ...
    <div class="mt-12 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-8 p-8">


        <div class="card flex p-6 bg-white border-2 border-amber-400 justify-start items-start gap-3.5 inline-flex">
            <div class="flex-col justify-start items-start gap-2.5 inline-flex">
                <img class="object-contain" src="https://via.placeholder.com/150x125" />
                <p>136 Products</p>
            </div>

            <div class="flex-col justify-start items-start gap-3 inline-flex">
                <h3>Carbon Composition Resistors</h3>
                <div class="self-stretch">
                    <p class="sm">Pellentesque habitant morbi tristique stus et netus et mlesuada fames ac turpis egestas... </p></div>
                </div>
            </div>
