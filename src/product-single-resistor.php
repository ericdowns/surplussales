    ...
    <div class="flex w-full mx-auto flex-col lg:flex-row px-5p py-20 gap-8">
        ...
        <div class="flex gap-8 flex lg:w-[30%] w-full">
            <div class="flex w-full flex-col gap-3">
                <div class="border flex w-full">
                    <img class="w-full h-auto block" src="./imgs/placeholder-resistor.png"> 
                </div>
                <div class="flex gap-3">
                    <img class="w-[72px] h-auto block border border-amber-400" src="./imgs/placeholder-resistor.png"> 
                    <img class="w-[72px] h-auto block" src="./imgs/placeholder-resistor.png"> 
                </div>
            </div>
        </div>
        <div class="w-full gap-8 flex xl:w-[70%] lg:w-[70%] md:w-full lg:flex-row flex-col">
            <div class="content_pricing flex flex-col lg:w-[60%] w-full">
                <h1 class="uppercase mb-5 hidden lg:block">Carbon Composition Resistors - 1/8 watt (RC) </h1>
