        ...
        <div class="grid gap-10 lg:grid-cols-2  grid-cols-1 ">
            ...
            <div>
             ...
             <div class="flex flex-wrap pt-6 gap-2 hover:[&>a]:bg-cream hover:[&>a]:text-black ">
              ...
              px-2.5 py-1.5 text-center text-red lg:text-base text-sm font-bold leading-none hover:*:bg-black">Popular:
          </div>
          <a href="/" class="btn_small">Capacitors</a> 
          <a href="/" class="btn_small">Resistors</a> 
          <a href="/" class="btn_small">Transformers</a> 
          <a href="/" class="btn_small">Motors & Solenoids</a> 
      </div>
  </div>
</div>
</div>
